# TA-P12-006 Web Console v2.1 运营与应急面板（2026-03-03）
...
- 校验项：
  ...
  3. CSS 存在风险看板与应急输入样式。
- 产出机读清单：
  - `docs/implementation/phase-12/manifests/2026-03-03-p12-web-console-v21-check.json`
...
corepack pnpm --filter @telagent/web exec node scripts/run-phase12-console-v21-check.mjs
```
...
- 日志：
  - `docs/implementation/phase-12/logs/2026-03-03-p12-web-build.txt`
  - `docs/implementation/phase-12/logs/2026-03-03-p12-web-test.txt`
  - `docs/implementation/phase-12/logs/2026-03-03-p12-web-console-v21-check-run.txt`
- 清单：
  - `docs/implementation/phase-12/manifests/2026-03-03-p12-web-console-v21-check.json`
...
- `TA-P12-006`：PASS
- Web Console v2.1 已具备审计快照、DLQ 批量重放与风险看板，满足本任务验收目标。
