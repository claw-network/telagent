...
async function main() {
  ...
  const outputPath = process.env.P16_CONSOLE_CONTRACT_REGRESSION_OUTPUT_PATH
    ?? process.env.P16_WEB_CONTRACT_REGRESSION_OUTPUT_PATH
    ?? path.resolve(repoRoot, 'docs/implementation/phase-16/manifests/2026-03-03-p16-console-contract-regression-check.json');
